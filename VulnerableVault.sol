...
contract VulnerableVault { 
    ...
    modifier enoughStaked(uint amount) {
        uint result = SafeMath.sub(balance[msg.sender],amount, 'Incorrect amount calculation');
		require(
            (result) > 0,
    ...
    */
    ...
    function claimRewards() external {	
        ...
        /* Check external call result */
        require(success, 'Not enough Privileges');
